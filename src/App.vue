      ...
      <div class="sidebar" :class="{ collapsed: isCollapsed }">
        ...
        <div class="custom-menu">
          ...
          <div class="submenu" v-show="expandedMenus.includes('inventory')">
            ...
            <div class="submenu" v-show="expandedMenus.includes('supplier-appointment')">
              ...
              <div class="submenu-item" @click="navigateTo('/admin/quote-management/amazon-warehouse')">
                <span class="submenu-title">平台地址管理</span>
              </div>
            </div>
          ...
          <div class="menu-item" :class="{ active: activeMenu.startsWith('/work-order') }" @click="toggleSubmenu('work-order')">
            ...
            <i class="menu-arrow el-icon-arrow-down" :class="{'is-open': expandedMenus.includes('work-order')}"></i>
          </div>
          ...
          <div class="menu-item" :class="{ active: activeMenu.startsWith('/messages') }" @click="toggleSubmenu('messages')">
            ...
            <i class="menu-arrow el-icon-arrow-down" :class="{'is-open': expandedMenus.includes('messages')}"></i>
          </div>

          <!-- 消息管理子菜单 -->
          <div class="submenu" v-show="expandedMenus.includes('messages')">
            <div class="submenu-item" :class="{ active: activeMenu === '/messages' }" @click="navigateTo('/messages')">
            ...
            <div class="submenu-item" :class="{ active: activeMenu === '/messages/manage' }" @click="navigateTo('/messages/manage')">
              <span class="submenu-title">消息管理</span>
            </div>
          </div>
          ...
          <div class="submenu" v-show="expandedMenus.includes('admin')">
            ...
            <!-- 标签管理 (父菜单) -->
            <div class="menu-item" :class="{ active: activeMenu.startsWith('/admin/tag-management') }" @click="toggleSubmenu('admin-tag')">
              <i class="el-icon-price-tag menu-icon"></i>
              <span class="menu-title">标签管理</span>
              <i class="menu-arrow el-icon-arrow-down" :class="{'is-open': expandedMenus.includes('admin-tag')}"></i>
            </div>
            ...
            <!-- 标签系统 (父菜单) -->
            <!-- <div class="menu-item" :class="{ active: activeMenu.startsWith('/admin/tag-system') }" @click="toggleSubmenu('admin-tag-system')">
              <i class="el-icon-price-tag menu-icon"></i>
              <span class="menu-title">标签系统</span>
              <i class="menu-arrow el-icon-arrow-down" :class="{'is-open': expandedMenus.includes('admin-tag-system')}"></i>
            </div> -->
            
            <!-- 标签系统子菜单 -->
            <!-- <div class="submenu" v-show="expandedMenus.includes('admin-tag-system')">
              <div class="submenu-item" :class="{ active: activeMenu === '/admin/tag-system/library' }" @click="navigateTo('/admin/tag-system/library')">
                <span class="submenu-title">标签库管理</span>
              </div>
              <div class="submenu-item" :class="{ active: activeMenu === '/admin/tag-system/rules' }" @click="navigateTo('/admin/tag-system/rules')">
                <span class="submenu-title">智能规则配置</span>
              </div>
              <div class="submenu-item" :class="{ active: activeMenu === '/admin/tag-system/dashboard' }" @click="navigateTo('/admin/tag-system/dashboard')">
                <span class="submenu-title">数据看板</span>
              </div>
            </div> -->
...
export default {
  ...
  data() {
    return {
      isCollapsed: false,
      activeMenu: '/',
      expandedMenus: ['lastmile', 'inventory', 'overseas', 'supplier', 'supplier-order', 'supplier-quote', 'supplier-rating', 'admin', 'admin-contract', 'supplier-appointment', 'work-order', 'admin-tag', 'admin-tag-system']
    }
  },
  methods: {
    toggleCollapse() {
